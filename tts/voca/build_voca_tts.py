...
def build_one(
    ...
    # 이 오디오 파일에서 실제 TTS API로 전송한 문자 수
    file_chars = 0
...
def run(
    ...
    print("=" * 70)
    print(
        "ManyLangs Vocabulary TTS Builder"
    )
    print("=" * 70)
