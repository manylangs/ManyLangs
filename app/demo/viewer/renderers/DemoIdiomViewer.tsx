...
export default function DemoIdiomViewer({
  ...
  const guideTexts: Record<string, string[]> = {
    ...
    ru: [
      ...
      "3. Вы можете перейти к следующему набору с помощью кнопок <> под аудио.",
      "4. Нажмите или коснитесь предложения, чтобы воспроизвести только эту часть.",
      "5. Нажмите Toggle Target, чтобы скрыть целевой язык и практиковать перевод.",
      "6. Сейчас вы просматриваете A1 Chapter 1. Вы можете выбрать уровни A1, A2, B1, B2, C1 и C2.",
    ],
  };
  ...
  const disclaimerTexts: Record<string, string> = {
    ...
    ru: "Переводы выполнены таким образом, чтобы передать смысл оригинального текста без использования дословных соответствий идиоматических выражений.",
  };
